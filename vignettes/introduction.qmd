...
`classquiz` is designed to use google forms to ask questions, google sheets to store the responses, [observable](https://observablehq.com/) to download the results from google sheets, process and plot them in the lecture slides.
